...
class Rand
{
    ...
    public static function digit($length = 4): string
    {
        return self::rand(self::DIGIT, $length);
    }

    public static function alpha($length = 4): string
    {
        return self::rand(self::ALPHA, $length);
    }

    public static function alnum($length = 4): string
    {
        return self::rand(self::ALNUM, $length);
    }

    public static function lower($length = 4): string
    {
        return self::rand(self::LOWER, $length);
    }

    public static function lower_num($length = 4): string
    {
        return self::rand(self::LONUM, $length);
    }

    public static function upper($length = 4): string
    {
        return self::rand(self::UPPER, $length);
    }

    public static function upper_num($length = 4): string
    {
        return self::rand(self::UPNUM, $length);
    }

    public static function human($length = 4): string
    {
        return self::rand(self::HUMAN, $length);
    }

    public static function rand($chars, $length): string
    {
        $size = strlen($chars) - 1;
        $str = '';
        for ($i = 0; $i < $length; $i++) {
    ...
    public static function chinese($length = 3): string
    {
